...
execute unless data storage icache:cache settings run data modify storage icache:cache settings set value {scan_enderchest:1b,scan_pets:1b}
execute in minecraft:overworld run forceload add 0 0
execute in minecraft:overworld run setblock 0 -62 0 minecraft:barrel replace
