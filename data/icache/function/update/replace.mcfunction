$execute in minecraft:overworld run item replace block 0 -62 0 container.0 from entity @s $(slot)
$data modify storage icache:temp slot_name set value "$(slot)"
execute in minecraft:overworld run data modify storage icache:temp slot set from block 0 -62 0 Items[0]
