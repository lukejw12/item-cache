...
function icache:admin/folder/build_list
scoreboard players set #icache.index icache.action 0
scoreboard players set #icache.shown icache.action 0
execute store result score #icache.total icache.action run data get storage icache:temp folder_items
