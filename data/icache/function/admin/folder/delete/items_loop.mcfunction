...
function icache:admin/folder/delete/items_check with storage icache:temp del_check
data remove storage icache:temp del_scan[0]
execute if data storage icache:temp del_scan[0] run function icache:admin/folder/delete/items_loop