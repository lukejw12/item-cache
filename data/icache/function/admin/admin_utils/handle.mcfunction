...
execute if score @s icache.action matches 31 run dialog show @s icache:search
execute if score @s icache.action matches 32 run function icache:admin/settings/menu
execute if score @s icache.action matches 33 run function icache:admin/settings/toggle_enderchest
execute if score @s icache.action matches 34 run function icache:admin/settings/toggle_pets
