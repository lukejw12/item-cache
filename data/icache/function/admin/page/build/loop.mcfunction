...
function icache:admin/page/build/check with storage icache:temp check
data remove storage icache:temp scan[0]
execute if data storage icache:temp scan[0] run function icache:admin/page/build/loop